...
const RegisterPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-trb g-slate-100 px-4 py-12 select-none">
            <div className="w-full max-w-md rounded-2xl bg-white/95 p-8 shadow-2xl backdrop-blur-md border border-white/20 transition-all duration-300 hover:shadow-indigo-500/20">
                ...
                <h1 className="text-gray-700 mt-3 gap-1 flex items-center  text-lg">If You do not have an Acount <Link href={'/login'} className="text-blue-500 hover:underline">login</Link></h1>
            </div>
        </div>
    );
};
